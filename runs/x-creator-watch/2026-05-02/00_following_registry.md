# X Following Registry - @xiaoyuZorro

Source: https://x.com/xiaoyuZorro/following
Collection method: Safari via Computer Use accessibility tree
Started: 2026-05-02
Status: in_progress

## Categories

- AI_CORE: AI labs, AI infra, model researchers, agent builders, AI product builders.
- US_STOCKS_MACRO: US stocks, global capital markets, macro, semiconductors, equity research.
- CRYPTO_WEB3: crypto, DeFi, wallets, stablecoins, exchanges, polymarket, web3 funds.
- PRODUCT_GROWTH: founders, growth, GTM, creator business, indie products.
- OTHER: lifestyle, art, unrelated or unclear accounts.

## Registry

| # | Handle | Name | Category | Visible bio / reason |
|---:|---|---|---|---|
| 1 | @tnm | Ted Nyman | AI_CORE | OpenAI/devtools; prev Cased CEO and GitHub CTO. |
| 2 | @rwayne | Roland.W | US_STOCKS_MACRO | Medicine/econ PhD; subscription content, economics signal. |
| 3 | @OpenAINewsroom | OpenAI Newsroom | AI_CORE | Official OpenAI newsroom. |
| 4 | @yiqifacai | 一起发财 | US_STOCKS_MACRO | AI-built one-person brokerage; market reports, AI investing opportunities. |
| 5 | @frostming90 | Frost Ming | AI_CORE | Python/PyPA/PDM developer; tooling ecosystem. |
| 6 | @goodhunt | Hunter Bown | OTHER | No visible bio. |
| 7 | @nicdunz | Nic | AI_CORE | Codex Mission Control; Mac-first control room for Codex. |
| 8 | @tig88411109 | Tigris | US_STOCKS_MACRO | Fund partner/professor CFA; macro, tech, AI, semis, cycles. |
| 9 | @stark_nico99 | Nicolechan | PRODUCT_GROWTH | Overseas growth; Building YouMind; ex Tencent/CM Securities content. |
| 10 | @aleabitoreddit | Serenity | US_STOCKS_MACRO | WSB trader; AI/Semi supply chain analyst; AI research scientist. |
| 11 | @leifuchen | leifu _/ | OTHER | No visible bio. |
| 12 | @HiddenFundsData | 暗流 | US_STOCKS_MACRO | Market fund flow tracking and analysis. |
| 13 | @pingchn | Ping. | AI_CORE | Creator of @ideashellAI. |
| 14 | @jaredliu_bravo | Jared 宗源 | PRODUCT_GROWTH | Growing YouMind; Founder Tidyread; productivity automation. |
| 15 | @agupta | Ankit Gupta | PRODUCT_GROWTH | YC GP; cofounder Reverie Labs acquired. |
| 16 | @Manxis_lab | ManXis | AI_CORE | Next-generation AI Agents; general-purpose agentic intelligence. |
| 17 | @swyx | swyx | AI_CORE | AI Engineer, Latent Space, Cognition, Temporal. |
| 18 | @vercel | Vercel | AI_CORE | Agentic infrastructure for apps and agents. |
| 19 | @llama_index | LlamaIndex | AI_CORE | LlamaIndex and LlamaParse AI document OCR. |
| 20 | @PortkeyAI | Portkey | AI_CORE | Production AI platform. |
| 21 | @helicone_ai | Helicone | AI_CORE | LLMOps, AI Gateway, LLM observability, OSS. |
| 22 | @levelsio | levelsio | PRODUCT_GROWTH | Indie products, PhotoAI/InteriorAI and revenue. |
| 23 | @rauchg | Guillermo Rauch | PRODUCT_GROWTH | Vercel CEO. |
| 24 | @matt_gray_ | Matt Gray | PRODUCT_GROWTH | Systems, audience/content growth, FounderOS. |
| 25 | @fyldVan | 匿名小灯 | OTHER | General creator. |
| 26 | @RampLabs | Ramp Labs | OTHER | No visible bio. |
| 27 | @evanlong_me | Evan Long | PRODUCT_GROWTH | Product sharing. |
| 28 | @wWw1152228 | 书虫 | PRODUCT_GROWTH | APIMart founder; API relay service; entrepreneurship. |
| 29 | @APIMart_ | APIMart | PRODUCT_GROWTH | API relay service. |
| 30 | @turingou | 郭宇 guoyu.eth | PRODUCT_GROWTH | Retired builder/investor signal. |
| 31 | @edwinarbus | edwin | AI_CORE | @cursor_ai; previously OpenAI and Stripe. |
| 32 | @Mengmengeth | 萌萌 | CRYPTO_WEB3 | Meme/altcoin trader; BNB/binance; long/short trading. |
| 33 | @BoyuanChen0 | Boyuan Chen | AI_CORE | OpenAI researcher; GPT Image; world models/RL/robotics. |
| 34 | @AbstractVC | Abstract VC | US_STOCKS_MACRO | SF VC firm; $1.8B AUM. |
| 35 | @DanielEdrisian | daniel | AI_CORE | @blackstar_cmptr; prev Codex @OpenAI. |
| 36 | @chad9793 | YourCHAD | CRYPTO_WEB3 | Full-time trader; meme coin. |
| 37 | @benjamincowen | Benjamin Cowen | US_STOCKS_MACRO | Macro, commodities, digital assets, liquidity/labor/risk cycles. |
| 38 | @APompliano | Anthony Pompliano | US_STOCKS_MACRO | Entrepreneur/investor; Pomp letter/show/podcast/book. |
| 39 | @goodside | Riley Goodside | AI_CORE | Former Google DeepMind and Scale AI. |
| 40 | @hwchase17 | Harrison Chase | AI_CORE | LangChain. |
| 41 | @rektcapital | Rekt Capital | CRYPTO_WEB3 | Crypto investor and analyst. |
| 42 | @emollick | Ethan Mollick | AI_CORE | Wharton professor studying AI, innovation, startups. |
| 43 | @beefnoode | 来碗牛肉粉 | AI_CORE | AI relay and B2B enterprise AI transformation. |
| 44 | @yifan_zhang_ | Yifan Zhang | AI_CORE | Princeton AI Lab; LLM reasoning/RL/pretraining. |
| 45 | @0xZhuya | 蛀牙虫分牙 | OTHER | Generic bio. |
| 46 | @AlizerWong | Alizer Wong | OTHER | No visible bio. |
| 47 | @btc_jx | 静香小姐 | CRYPTO_WEB3 | Crypto trading records. |
| 48 | @thsottiaux | Tibo | AI_CORE | Codex @OpenAI. |
| 49 | @OpenAIDevs | OpenAI Developers | AI_CORE | Codex and OpenAI Platform updates. |
| 50 | @rileybrown | Riley Brown | AI_CORE | YouTuber/educator; cofounder Vibecode app. |
| 51 | @Hicker_Moledao | Hickerzed | CRYPTO_WEB3 | Blockchain student; ambassador; AI. |
| 52 | @xbt2027 | xbt2027 | CRYPTO_WEB3 | Crypto-adjacent handle and bio. |
| 53 | @chen_xiao95600 | 皕五 | CRYPTO_WEB3 | Trading education; paid entry. |
| 54 | @CreaoAI | CreaoAI | AI_CORE | Super agent beyond chat window. |
| 55 | @Leonard_Aster | Leonard | CRYPTO_WEB3 | CEO Aster DEX; decentralized trading. |
| 56 | @Leobai825 | 天策 | PRODUCT_GROWTH | Shenzhen Amazon operator; cross-border ecom/Web3/AI. |
| 57 | @xkajon | Kai | PRODUCT_GROWTH | B2B; US company and enterprise channels. |
| 58 | @ccjing_eth | ccjing | CRYPTO_WEB3 | DeFi/Alpha/AI/Vibe coding. |
| 59 | @myao_nyaa_ | myao | OTHER | neko/fanbox. |
| 60 | @not_racc | Tra的美本日记 | AI_CORE | Wellesley + MIT student; AI, build in public, long-termism. |
| 61 | @yifeng0571 | Reex | US_STOCKS_MACRO | 先信资本. |
| 62 | @newsliquidX | Newsliquid | US_STOCKS_MACRO | Full-stack AI trading terminal backed by 6551. |
| 63 | @Super4DeFi | benmo.eth | CRYPTO_WEB3 | HK liquidity community and investment lifestyle. |
| 64 | @UnifiedLabs_ | Unified Labs | CRYPTO_WEB3 | Asia RWA risk curator on Morpho. |
| 65 | @big_tech_sux | sudo init vyper | CRYPTO_WEB3 | Vyperlang. |
| 66 | @vyper_cn | Vyper中文 | CRYPTO_WEB3 | Vyper Chinese smart-contract developer community. |
| 67 | @wuk_Bitcoin | Donato | CRYPTO_WEB3 | Bitcoin/financial disclaimer. |
| 68 | @huahuayjy | 花花 | OTHER | Lifestyle. |
| 69 | @nine_DeFi | nine_ | CRYPTO_WEB3 | Alpha hunter; Binance/OKX; building HoNobuild2026. |
| 70 | @trq212 | Thariq | AI_CORE | Claude Code @Anthropic; prev YC W20/SPC/MIT Media Lab. |
| 71 | @AlphClaw | AlphClaw | AI_CORE | Telegram bot powered by OpenClaw logic. |
| 72 | @Yuancheng | koji | AI_CORE | AI podcast/newsletter Crossing; AI Hacker House; ZhenFund partner. |
| 73 | @LufzzLiz | 岚叔 | AI_CORE | AI products, multimodal/private model architecture, AI education/art creation. |
| 74 | @Lonely__MH | Lonely | AI_CORE | Indie hacker; AI tool reviews; code; tech investing. |
| 75 | @AlchainHust | 花叔 | AI_CORE | AI Native Coder; YouTube/Bilibili; 女娲.skill. |
| 76 | @mcuban | Mark Cuban | US_STOCKS_MACRO | Entrepreneur/public business figure; costplusdrugs. |
| 77 | @NousResearch | Nous Research | AI_CORE | Open-source AI. |
| 78 | @gmwalletapp | GM Wallet | CRYPTO_WEB3 | Open-source multi-chain crypto wallet. |
| 79 | @0xAstraSpark | Astra | CRYPTO_WEB3 | Blockchain infra founder; crypto payment solution; building GM Wallet. |
| 80 | @hildaiscute | Hilda辣辣 | CRYPTO_WEB3 | Web3 + AI marketing intern. |
| 81 | @karminski3 | karminski-牙医 | PRODUCT_GROWTH | Coder, KCORES co-founder, ex IllaSoft/KingsoftOffice/Juejin. |
| 82 | @nicbstme | Nicolas Bustamante | AI_CORE | AI for knowledge workers at Microsoft; prev Fintool. |
| 83 | @gregisenberg | GREG ISENBERG | PRODUCT_GROWTH | Startup ideas daily; Late Checkout companies. |
| 84 | @businessbarista | Alex Lieberman | PRODUCT_GROWTH | Tenex Labs, Morning Brew, Storyarb; AI engineering and transformation. |
| 85 | @adocomplete | Ado | AI_CORE | Community, Claude, Code at Anthropic. |
| 86 | @mstockton | Matt Stockton | AI_CORE | LLM writing and AI/ML consulting. |
| 87 | @dani_avila7 | Daniel San | AI_CORE | Head of AI; Claude Code SubAgents, Skills, Hooks; OSS aitmpl. |
| 88 | @wey_gu | Wey Gu 古思为 | AI_CORE | NowledgeLabs/NowledgeMem; Microsoft MVP; prev NebulaGraph/Ericsson Cloud. |
| 89 | @huolongguodomgt | 龙共火火 | AI_CORE | MCN boss; building an AI app company. |
| 90 | @NekoStranding | 毒猫猫 | US_STOCKS_MACRO | Quant engineer; daily market observation; Agent @myth_claws. |
| 91 | @GMwalletHK | GM Wallet 华语 | CRYPTO_WEB3 | GMwallet developer; semantic asset-layer wallet. |
| 92 | @meanc_p | meanc | OTHER | Code and personal account. |
| 93 | @PenPizzaReport | Pentagon Pizza Report | US_STOCKS_MACRO | Open-source tracking of Pentagon-area pizza activity. |
| 94 | @willdepue | will depue | AI_CORE | Retired ex OpenAI; Sora, posttraining o3/4o, pretraining. |
| 95 | @antoniayly | antoniayly | CRYPTO_WEB3 | GTM Engineer; Web3 background and partnerships. |
| 96 | @DarioAmodei | Dario Amodei | AI_CORE | Anthropic CEO. |
| 97 | @dgt10011 | Jeff Park | US_STOCKS_MACRO | Bitwise advisor; Radical Portfolio Theory CIO; ex Morgan Stanley/Stanford. |
| 98 | @SuperBILI | BILI | CRYPTO_WEB3 | In2ventures cofounder; building InSquareDAO. |
| 99 | @KobeissiLetter | The Kobeissi Letter | US_STOCKS_MACRO | Global capital markets commentary. |
| 100 | @DC__CRYPT | D C CRYPT | CRYPTO_WEB3 | Aster DEX ambassador; trader; macroeconomic analyst. |
| 101 | @BNBCHAIN | BNB Chain | CRYPTO_WEB3 | BNB Chain official/stablecoin transactions. |
| 102 | @liudao888 | 六道 | CRYPTO_WEB3 | DeFi trader; project digging; leverage and airdrops. |
| 103 | @smartestmoney | smartestmoney.hl | CRYPTO_WEB3 | Hyperliquid community/trading. |
| 104 | @tinghao_ai | Trevor Zhang | PRODUCT_GROWTH | Founder and CEO; building. |
| 105 | @AvrilynLi | Avrilyn_n | AI_CORE | Building AI at 失序实验室; Product x GTM. |
| 106 | @plantegg | plantegg | AI_CORE | Claude Code, AI, Agent, cloud service commentary. |
| 107 | @jasonrosenthal | Jason Rosenthal | CRYPTO_WEB3 | Operating Partner @a16zcrypto; frontier tech and exits. |
| 108 | @FundaAI | FundaAI | US_STOCKS_MACRO | AI Invest OS; agents, equity research reports and data. |
| 109 | @pandaskiing | pandaskiing | PRODUCT_GROWTH | Ex-founder @forgex_tools acquired. |
| 110 | @linquan929 | 做饭普拉斯 | OTHER | Adult/personal content signal. |
| 111 | @benjitaylor | Benji Taylor | AI_CORE | Leading design @x/@xai; prev Base; founder Family. |
| 112 | @urDaniel777 | Daniel AstralX | CRYPTO_WEB3 | BD @astralxcom; Web3 partnerships and growth. |
| 113 | @Wanamaker_X | Yull | CRYPTO_WEB3 | Founder MemeX_MRC20. |
| 114 | @Lakr233 | 砍砍. | OTHER | Personal account; qaq.wiki. |
| 115 | @geekbb | Geek | OTHER | Tech/geek lifestyle. |
| 116 | @momochenming | MOMO默默 | CRYPTO_WEB3 | In2ventures cofounder; KOL manager; BNB/Binance. |
| 117 | @KASTxyz | KAST | CRYPTO_WEB3 | Stablecoin financial platform. |
| 118 | @sikiri0 | Masil | CRYPTO_WEB3 | Founder Waitstudy; edgeX ambassador. |
| 119 | @Sae_Art | Sae | OTHER | Art and streaming. |
| 120 | @web3kangkang | web3 康康 | CRYPTO_WEB3 | Crypto/web3 content. |
| 121 | @Healing_chemist | Healing | OTHER | General aphorism. |
| 122 | @ninjapills | ninja chill pills | CRYPTO_WEB3 | Marketing manager, solpump. |
| 123 | @bdsqlsz | 青龍聖者 | AI_CORE | Pika Labs/SkyReels; architectural model; tylab.ai. |
| 124 | @dj673285379 | J King | CRYPTO_WEB3 | NFT collector; community builder; OpenMind AGI mod signal. |
| 125 | @0xBFRuby | Ruby | CRYPTO_WEB3 | Metrics Ventures. |
| 126 | @wadezone | Koda | AI_CORE | One-person company; AI restart on X; programmer/cross-border creator. |
| 127 | @zorrothefish | fish 一条鱼 | OTHER | Personal account. |
| 128 | @GoSailGlobal | Jason Zhu | AI_CORE | Cursor-certified; building AI products in public; skills hub. |
| 129 | @goo_economy | Goo Economy | US_STOCKS_MACRO | Open-sourced agentic financial layer protocol. |
| 130 | @o65518kuguagua | 咩咩 | OTHER | Personal account. |
| 131 | @ReyJudgementOS | Rey | OTHER | Education/judgment structure. |
| 132 | @sky27867843 | 0x辍学炒币 | US_STOCKS_MACRO | Economic/current-politics analysis; gold, crypto, stocks advice. |
| 133 | @LuckDuckC | LuckyDuck | CRYPTO_WEB3 | Meme/crypto sharing. |
| 134 | @EscapePlan0gu | EscapePlan 17 | CRYPTO_WEB3 | Polymarket trader. |
| 135 | @lex_tang | Lex Tang | CRYPTO_WEB3 | Digital cryptocurrency fan. |
| 136 | @protrade47 | Protrade | CRYPTO_WEB3 | Trading and Polymarket. |
| 137 | @Mask4che | Maskache | CRYPTO_WEB3 | Political/weather Polymarket betting. |
| 138 | @lexrus | Lex Tang | PRODUCT_GROWTH | iOS/macOS developer; apps. |
| 139 | @caterpillarous | #endif | OTHER | Comfortably numb; unclear fit. |
| 140 | @KillaXBT | Killa | US_STOCKS_MACRO | Quantitative trader, 7 years; educational market content. |
| 141 | @Sinda1118 | Sinda | OTHER | No visible bio. |
| 142 | @jukan05 | Jukan | PRODUCT_GROWTH | Tech otakus save the world; investing disclaimer. |
| 143 | @stockwilsonrice | 股海飯桶 wilson | US_STOCKS_MACRO | Industry researcher daily life, investment notes. |
| 144 | @woodycryptow | Woody | CRYPTO_WEB3 | Crypto handle and trading tone. |
| 145 | @jjgfscbd | 小马驹 | OTHER | Personal/design/paid chat. |
| 146 | @matr1x_xijue | 西决 1000X GEM | CRYPTO_WEB3 | Meme trading, review, tools, trading notes. |
| 147 | @Molly9975019573 | Molly 币圈大V推荐 | CRYPTO_WEB3 | Binance creator, crypto promotion. |
| 148 | @Mr_qiang777 | Mr&强 | CRYPTO_WEB3 | WEEX/Hotcoin/AstralX ambassador. |
| 149 | @donpanic_ | 头昏小子 | OTHER | Minimal/unclear. |
| 150 | @Nonoissss | Nonois | CRYPTO_WEB3 | DeFi, Web3 leader, crypto education. |
| 151 | @felixincrypto | YF | AI_CORE | Core Contributor @Virtuals_io; Chinese ecosystem. |
| 152 | @netanyahu | Benjamin Netanyahu | OTHER | Political/public figure. |
| 153 | @aadm122382142 | Aadm | CRYPTO_WEB3 | Alpha player; ex-web2 product manager. |
| 154 | @elliotchen100 | 艾略特 | AI_CORE | Building EverMind, memory for self-evolving agents. |
| 155 | @nikitabier | Nikita Bier | PRODUCT_GROWTH | Head of product @X; advisor Solana; Lightspeed venture partner. |
| 156 | @0xHeCai | 合财 HeCai | CRYPTO_WEB3 | Co-founder @3PDAO; trading tone. |
| 157 | @FortuneCutie00 | FortuneCutie饼干姐姐 | OTHER | Adult/fan content. |
| 158 | @localcat15 | 路人甲 | CRYPTO_WEB3 | Crypto degen; physics PhD candidate. |
| 159 | @zhizhuxia22 | 蜘蛛侠 1000X GEM | CRYPTO_WEB3 | Web3 hotspot tracking and trading diary. |
| 160 | @Hovz0217 | Hovz | CRYPTO_WEB3 | Coder, trader, Binance web3, Polyspots cofounder. |
| 161 | @StarkeToWin | Stake to Win | CRYPTO_WEB3 | Token staking lottery product. |
| 162 | @Vera548926 | William | CRYPTO_WEB3 | Full-time trader; GMGN challenge winner; onchain trading. |
| 163 | @TC8880 | TC | CRYPTO_WEB3 | Chinese Marketing Lead @predictdotfun. |
| 164 | @chipchipgame | CHIPCHIPGAME | CRYPTO_WEB3 | Crypto poker product. |
| 165 | @0xfanfanfan | 凡 | CRYPTO_WEB3 | Degen, trading review. |
| 166 | @WSJ | The Wall Street Journal | US_STOCKS_MACRO | Major business and markets publication. |
| 167 | @almaishuman | alma | OTHER | No visible bio. |
| 168 | @youzipee | Youzipee | AI_CORE | Building @insidersdotbot; prev UNESCAP and Solana_Zh intern. |
| 169 | @riverleaf88 | River Leaf | PRODUCT_GROWTH | Product creator; Routory and projector calculator. |
| 170 | @passluo | Passluo | OTHER | General cultural/personal account. |
| 171 | @kasplex | Kasplex | CRYPTO_WEB3 | First protocol for Kaspa ecosystem. |
| 172 | @thekasfun | KAS.FUN | CRYPTO_WEB3 | Memecoin launch platform on Kaspa. |
| 173 | @0xAir_8 | 0xAir_8 | CRYPTO_WEB3 | Primary-market crypto, hotspots, launches. |
| 174 | @Marshall3215 | Confiance13 | OTHER | Funny video. |
| 175 | @interjc | Justin | AI_CORE | AIGC; Osaka-based. |
| 176 | @FluxGray | Ren | OTHER | No visible bio. |
| 177 | @poly_beats | PolyBeats | US_STOCKS_MACRO | Prediction-market information mining account under BlockBeats. |
| 178 | @zodchiii | darkzodchi | US_STOCKS_MACRO | AI and finance entrepreneur; building PolymarketEye. |
| 179 | @x_sanjin | 熊三金Cole | AI_CORE | Testnetx founder; shares AI/Web3/airdrop opportunities. |
| 180 | @waronusd1 | WAR | CRYPTO_WEB3 | Pumpfun token account. |
| 181 | @evaiAaaa | 九月 | OTHER | General motivational bio. |
| 182 | @Iris_121314 | Iris | OTHER | General/personal bio. |
| 183 | @wallet | OKX Wallet | CRYPTO_WEB3 | Official OKX Wallet. |
| 184 | @xueqiu88 | 雪球 xueqiu | CRYPTO_WEB3 | Solana_zh cofounder/content creator; Binance web3 referral. |
| 185 | @KevinZhunter | KevinZ | US_STOCKS_MACRO | Crypto trader; includes oil trade signal and market aphorism. |
| 186 | @bangzhu_123 | 小日先生 web3 | US_STOCKS_MACRO | AI, Hong Kong and US stocks, web3 airdrops/launches. |
| 187 | @Cayden970207 | Cayden | AI_CORE | Web3 developer; AI-Agents expert; mini games and websites. |
| 188 | @J1N226 | J1N | AI_CORE | Web3 media; AI miner; CHIPCHIP. |
| 189 | @ebahuhansan | 恶霸胡汉三 | CRYPTO_WEB3 | CHIPCHIP community and crypto poker operations. |
| 190 | @DeJob_Official | DeJob | CRYPTO_WEB3 | Web3 job and talent platform. |
| 191 | @0xJerrrry | Jerry | CRYPTO_WEB3 | Prev @OdailyChina; crypto media signal. |
| 192 | @0xMoon | 0xMoon | CRYPTO_WEB3 | Binance/OKX wallet referral account. |
| 193 | @Seasui23 | 马来西亚小韭菜 | OTHER | No visible bio. |
| 194 | @LCwZsRdcrm44854 | kk | CRYPTO_WEB3 | Wallet address only. |
| 195 | @maxdothl | maxdawg.hl | CRYPTO_WEB3 | Polymarket copytrade account. |
| 196 | @GCsheng | 深大高财生.milady | CRYPTO_WEB3 | NFT/Binance/onchain opportunity account. |
| 197 | @0xduyan | 0x独眼 | CRYPTO_WEB3 | Alpha projects, DeFi yield, arbitrage, guides. |
| 198 | @novus771 | 77 | AI_CORE | AI, crypto, idea signal. |
| 199 | @sue1w0fw | Molly Molly | OTHER | No visible bio. |
| 200 | @Gniy666 | Duvet | OTHER | Original blogger/personal account. |
| 201 | @hfymomoj | 治疗术 | OTHER | Personal notes. |
| 202 | @stambouli_o1 | Jerry Pan | CRYPTO_WEB3 | Cofounder @o1_exchange; backed by Alliance and Coinbase Ventures; prev Databricks/BainCapVC. |
| 203 | @Greta0086 | Greta008 | CRYPTO_WEB3 | Crypto promotion/collaboration. |
| 204 | @EASYResidency | EASY Residency | AI_CORE | YZi Labs global incubation for Web3, AI, and Biotech founders. |
| 205 | @Monica_xiaoM | 加密小师妹 Monica | CRYPTO_WEB3 | Binance content creator; Web3. |
| 206 | @BTCqzy1 | 爱丽丝呀 | US_STOCKS_MACRO | Trader; onchain data; technical research across crypto, US stocks, AI. |
| 207 | @Listing_MGBX | Justin MGBX | CRYPTO_WEB3 | MGBX VP listing and partnership. |
| 208 | @DouXiao42633 | 小豆豆 | OTHER | No visible bio. |
| 209 | @FokLouis144 | Louis 霍霍 | CRYPTO_WEB3 | Consumer finance background, web3 research, NFT. |
| 210 | @AC66366 | 紫川 | CRYPTO_WEB3 | Crypto research and learning. |
| 211 | @spicycandy00 | 辣条味奶糖 | OTHER | Personal/motivational bio. |
| 212 | @youguqi2023 | 无双-明灯 | CRYPTO_WEB3 | DeFi, airdrops, web3 trading story. |
| 213 | @LewisKuo2 | Lewis爆肝战神 | US_STOCKS_MACRO | Programmer; AI Agent, DeFi, prediction market, Nasdaq. |
| 214 | @Pence0629 | Pence | CRYPTO_WEB3 | Web3/lifestyle. |
| 215 | @3333yyds | Nana | OTHER | Personal account. |
| 216 | @wangharry | 暂星 | US_STOCKS_MACRO | Big-tech risk control; US stocks, web3, AI, writing. |
| 217 | @Ai86666 | 北楼Pro | US_STOCKS_MACRO | Technical trader; investment research and value investing. |
| 218 | @qinggeqingq | qingge | AI_CORE | AI frontier technology sharing. |
| 219 | @CryptoBirdie_1 | 情绪稳定Birdie | CRYPTO_WEB3 | PKUBlockchain member; trader. |
| 220 | @vonzz6 | Winry | OTHER | Personal bio. |
| 221 | @xStocksFi_zh | xStocks 华语频道 | US_STOCKS_MACRO | Tokenized US stocks; TSLAx, NVDAx, SPYx. |
| 222 | @EliseFolso71390 | Walter_水子哥 | CRYPTO_WEB3 | Onchain retail flow and prediction market groups. |
| 223 | @ShiftProtocol_ | SHIFT Protocol | CRYPTO_WEB3 | Tokenizing high-yield opportunities. |
| 224 | @Backpack | Backpack | CRYPTO_WEB3 | Margin account in finance; trade, borrow, spend, earn. |
| 225 | @mianqing298464 | 临秋 | US_STOCKS_MACRO | Crypto predict, RWA US-stock trading, bottom-logic analysis. |
| 226 | @allen5951 | allen5951 | OTHER | Daily topics, network observation. |
| 227 | @huybery | Binyuan Hui | AI_CORE | Formerly @Alibaba_Qwen. |
| 228 | @JustinLin610 | Junyang Lin | OTHER | No relevant visible bio. |
| 229 | @valgui1 | Val | US_STOCKS_MACRO | Leading xStocks. |
| 230 | @errodenos133734 | BRIEF | AI_CORE | SkillsHub @Skill_BSC, open-source AI Agent skills library on BSC. |
| 231 | @heroyangv | Hero | CRYPTO_WEB3 | Hertzflow; backed by YZi Labs; ex-Coinbase CDP wallet and MPC infra. |
| 232 | @Leozayaat | Leo | CRYPTO_WEB3 | Building @42space; prev @alkimiya_io. |
| 233 | @Web3Eden01 | Eden | CRYPTO_WEB3 | Crypto account; investment disclaimer. |
| 234 | @AnchorNode | 大洋 | AI_CORE | Crypto, investment research, AI; structural-thinking creator. |
| 235 | @nyenchenn | 陈佩佩 | OTHER | Abstract artist. |
| 236 | @jingyu813363 | 21 | OTHER | Personal/adult signal. |
| 237 | @AEason_chen | 搓澡巾 | OTHER | Personal/abstract literature account. |
| 238 | @polychain | Polychain | CRYPTO_WEB3 | Polychain official investment/fund account. |
| 239 | @Zh_Crypto517 | Z大诗 | US_STOCKS_MACRO | Prediction market, Hong Kong/US stock trading, RWA, AI. |
| 240 | @xirichaoxi | 故事一无所有 | OTHER | Personal/paid chat. |
| 241 | @jellyfish11288 | jellyfish | OTHER | Personal account. |
| 242 | @chiroukyc | Web3_吃肉 | CRYPTO_WEB3 | Web3 service provider; AI/community tags. |
| 243 | @WildPig2006 | 野豬 | AI_CORE | AI monetization research, vibe projects, web3 airdrops. |
| 244 | @0xchubai | 初白 | AI_CORE | WEB3+AI, project research, beginner tutorials. |
| 245 | @0xMulight | Mulight 沐光 | US_STOCKS_MACRO | AI researcher and US stock analyst; AIGC video and agents. |
| 246 | @anorth_chen | North@CreaoAI | AI_CORE | Head of Community @CreaoAI; AI-focused CS background; ex Alibaba technical specialist. |
| 247 | @liujiayi1111 | 刘佳怡 | PRODUCT_GROWTH | TS/JS/React/Node.js/Python developer signal. |
| 248 | @WallStreetAiBot | 华尔街Ai机器人 | US_STOCKS_MACRO | Automated Wall Street AI posting bot. |
| 249 | @PolyshitNews | Polyshit news | US_STOCKS_MACRO | Prediction-market news account. |
| 250 | @taozihaochi4 | 小雨 | OTHER | Personal/friendship account. |
| 251 | @Jason23818126 | Dr. Moyu 摸鱼局长 | US_STOCKS_MACRO | Observation, decomposition, betting, life; AI, Web3, US stocks; super-individual practice. |
| 252 | @M4A1_SSS | Jack1e | OTHER | CTFer/gamer/general tech. |
| 253 | @DoveyWan | Dovey Wan | CRYPTO_WEB3 | Founder @primitivecrypto; crypto thesis and hiring. |
| 254 | @shengxj1 | 花果山大圣 | PRODUCT_GROWTH | Front-end/Web3 lecturer, programmer, indie developer. |
| 255 | @MetaWin | METAWIN.COM | CRYPTO_WEB3 | Crypto casino/sportsbook/prize platform. |
| 256 | @cz_122333 | 嗯 | OTHER | Personal/adult signal. |
| 257 | @zhangyuge211206 | 祁同伟厅长 | CRYPTO_WEB3 | Onchain wallet/trading account. |
