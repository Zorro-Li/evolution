...
Generated: 2026-04-26 13:37:50 CST
...
- HumanOS private-chat sample: 24 conversations, 418484 total messages, 301552 text messages, 1595 active days.
- Self text share: 48.1%; self character share: 50.3%.
- Average text length: self 8.88 chars, others 8.14 chars.
- Conversation initiation share: self 42.1%.
- Median cross-speaker reply latency: self 10s, others 12s.
- Marker profile: self support 1802, repair 339, clarity 2187, intimacy 7061.

## Relationship Pattern From Existing HumanOS Analyses

- Existing attachment batch: 24 conversations, high-data records 23.
- Self attachment distribution in generated reports: {"安全型": 23}.
- Self average scores: anxiety 12.91, avoidance 6.43, security 58.22, fear 9.65.
...
- Boundary: this is an interaction-pattern memory, not a clinical diagnosis.

## Work And Learning Pattern

- AI: 71 source hits across local materials.
- research: 27 source hits across local materials.
- RAG: 22 source hits across local materials.
- directness: 20 source hits across local materials.
- health: 16 source hits across local materials.
- psychology: 15 source hits across local materials.
- automation: 14 source hits across local materials.
- engineering: 8 source hits across local materials.
